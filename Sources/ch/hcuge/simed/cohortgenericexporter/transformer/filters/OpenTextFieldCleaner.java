...
public class OpenTextFieldCleaner extends ExportTransformer {

	public static Logger log = Logger.getLogger(OpenTextFieldCleaner.class);

	public OpenTextFieldCleaner() {
		super();
	}
	...
	public ExportTransformer newInstance() {
		return new OpenTextFieldCleaner();
	}
