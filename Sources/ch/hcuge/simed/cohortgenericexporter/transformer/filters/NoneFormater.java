...
public class NoneFormater extends ExportTransformer {

	public static Logger log = Logger.getLogger(NoneFormater.class);
	...
	public static String format(Object value) {
		...
		if (value.equals(ExporterConstante.NONE)) {
			return ExporterConstante.NO_CODE;
		} else
